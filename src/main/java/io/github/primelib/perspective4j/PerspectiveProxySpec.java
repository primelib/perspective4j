...
@Slf4j
public class PerspectiveProxySpec {
    /*
    ...
    /**
     * Constructs a validated implementation of {@link PerspectiveProxySpec}.
     *
     * @param spec the specification to process
     */
    @ApiStatus.Internal
    public PerspectiveProxySpec(Consumer<PerspectiveProxySpec> spec) {
        spec.accept(this);
        validate();
    }
    ...
    /**
     * Creates a new {@link PerspectiveProxySpec} with values taken from the proxy environment variables, if applicable.
     */
    public static PerspectiveProxySpec detect() {
        ...
        for (String p : proxies) {
            try {
                ...
                return new PerspectiveProxySpec(spec -> {
